 ...
 *
 * @param {any} value
 * @return {array} returns value if it is a non-empty array or [] for an empty array, undefined, null, etc
 */
 ...
 *
 * @param {any} value
 * @return {object} returns value if it is a non-empty object or {} for an empty object, undefined, null, etc
 */
 ...
 *
 * @param {any} value
 * @return {object} returns value if it is a non-empty string or '' for an empty string, undefined, null, etc
 */
...
export const setStateValue = (root, path, newValue, state) => {
  ...
  R.assocPath(actualPath, newValue, state)
}
